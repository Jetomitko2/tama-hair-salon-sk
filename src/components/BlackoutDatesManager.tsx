      ...
      <CardContent className="space-y-6">
            ...
            <Popover>
              <PopoverTrigger asChild>
                ...
                >
                  ...
                  {selectedDate ? format(selectedDate, "dd.MM.yyyy", { locale: sk }) : "Vyberte dátum"}
                </Button>
              </PopoverTrigger>
        ...
        <div className="space-y-4">
          ...
          {blackoutDates.length === 0 ? (
            <p className="text-muted-foreground">Žiadne zakázané dátmy</p>
          ) : (
                ...
                >
                  <div className="flex items-center space-x-3">
                    <Badge variant="outline">
                      {format(new Date(blackoutDate.date), "dd.MM.yyyy", { locale: sk })}
                    </Badge>
                    {blackoutDate.reason && (
