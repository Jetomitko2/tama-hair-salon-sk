  ...
  return <section className="py-20 bg-muted/50">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16 animate-fade-up">
          <h2 className="text-3xl md:text-4xl font-bold text-primary mb-4">Služby</h2>
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">Ponúkam kompletnú paletu kadernícka služieb pre každého klienta</p>
        </div>
