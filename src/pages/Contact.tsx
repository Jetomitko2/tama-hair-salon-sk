          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 max-w-6xl mx-auto">
            ...
            <Card className="salon-shadow-elegant hover:salon-shadow-card transition-spring hover:-translate-y-2 animate-fade-up">
              <CardHeader className="text-center">
                <Clock className="h-10 w-10 sm:h-12 sm:w-12 text-accent mx-auto mb-3 sm:mb-4" />
                <CardTitle className="text-primary text-lg sm:text-xl">Otváracie hodiny</CardTitle>
              </CardHeader>
              <CardContent className="text-center space-y-1 sm:space-y-2">
                ...
                <div className="flex justify-between items-center border-t pt-1 sm:pt-2 text-sm sm:text-base">
            ...
            <Card className="salon-shadow-elegant hover:salon-shadow-card transition-spring hover:-translate-y-2 animate-fade-up animate-delay-200">
              <CardHeader className="text-center">
                ...
                <CardTitle className="text-primary text-lg sm:text-xl">Telefónny kontakt</CardTitle>
              </CardHeader>
              <CardContent className="text-center">
                <a href="tel:+421908989423" className="text-xl sm:text-2xl font-bold text-accent hover:text-salon-primary-light transition-smooth">
                  0908 989 423
                </a>
                <p className="text-muted-foreground mt-3 sm:mt-4 text-sm sm:text-base px-2">Zavolajte mi pre objednanie termínu alebo informácie o našich službách</p>
              </CardContent>
            </Card>
            ...
            <Card className="salon-shadow-elegant hover:salon-shadow-card transition-spring hover:-translate-y-2 animate-fade-up animate-delay-400 md:col-span-2 lg:col-span-1">
              <CardHeader className="text-center">
                ...
                <CardTitle className="text-primary text-lg sm:text-xl">Naša adresa</CardTitle>
              </CardHeader>
              <CardContent className="text-center">
                ...
                <p className="text-muted-foreground mt-3 sm:mt-4 text-sm sm:text-base px-2">Nachádzam sa v centre Trebišova, ľahko dostupní pešo aj autom</p>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="mt-12 sm:mt-16 text-center animate-fade-up">
            <Card className="max-w-2xl mx-auto salon-shadow-card">
              <CardHeader>
                ...
                <CardTitle className="text-primary text-lg sm:text-xl">Dôležité informácie</CardTitle>
              </CardHeader>
              <CardContent>
